...
<nav class="navbar navbar-expand-lg navbar-dark bg-success">
    <div class="container">
        <a class="navbar-brand" href="#">🍎 水果訂貨平台 - 新增交易</a>
...
<section class="container my-5">
    <form method="post" class="p-4 border rounded shadow-sm">
        <div class="mb-3">
            <label class="form-label">水果編號</label>
        ...
        <button type="submit" name="add_transaction" class="btn btn-primary w-100">成立訂單</button>
    </form>
